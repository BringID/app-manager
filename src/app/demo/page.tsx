...
const BRINGID_APP_IDS: Record<number, bigint> = {
  [base.id]: 39878832286010715161630748446943853496783028537729571908964762798230393014706n,
  [baseSepolia.id]: 76265609404091461520395677114574630738278816758607719643509156495231297287556n,
};
